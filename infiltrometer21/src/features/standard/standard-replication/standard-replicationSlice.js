...
export const standardReplicationSlice = createSlice({
  name: 'standardReplication',
  initialState,
...
export const { setVolume, setSecondsElapsed, setLastVolume } = standardReplicationSlice.actions;


export const selectLastVolume = (state) => state.standardReplication.lastVolume;

export default standardReplicationSlice.reducer;