 ...
 * We need slices to 
 */
export const standardInitializeSlice = createSlice({

  name: 'standardInitialize',
...
//export the actions
export const { setInitialVolume, setInfiltrometerSuction, setTimeInterval, setSoilType, setInfiltrometerData } = standardInitializeSlice.actions;



export default standardInitializeSlice.reducer;