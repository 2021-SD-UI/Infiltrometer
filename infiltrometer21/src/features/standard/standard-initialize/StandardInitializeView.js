...
} from './standard-initializeSlice';
import { setLastVolume, setSecondsElapsed, setVolume } from '../standard-replication/standard-replicationSlice';
  ...
  const handleSubmit = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      addGeoDataToReading({ volume, secondsElapsed: 0 }, (reading) => {
        ...
        dispatch(setPage(Pages.StandardReplicationView));
    ...
    <>
      <Container className="mt-3">
        <div class="rounded border shadow">
          <h1 className="pt-5 display-4">Initialize Standard Protocol</h1>
